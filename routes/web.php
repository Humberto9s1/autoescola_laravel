...
Route::get('instrutores/{instrutor}/edit', [CadInstrutoresController::class, 'edit'])->name('instrutores.edit');
Route::put('instrutores/{instrutor}', [CadInstrutoresController::class, 'editar'])->name('instrutores.editar');
